...
static bool decode_C509Certificate(
		zcbor_state_t *state, struct C509Certificate *result)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_list_start_decode(state) && ((((decode_TBSCertificate(state, (&(*result).TBSCertificate_m))))
	&& ((zcbor_any_skip(state, NULL)))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_list_end_decode(state))));
...
static bool decode_All(
		zcbor_state_t *state, struct All *result)
{
	zcbor_log("%s\r\n", __func__);

	bool res = (((zcbor_map_start_decode(state) && (((((decode_C509Certificate(state, (&(*result).C509Certificate_key))))
	&& (decode_C509Certificate(state, (&(*result).C509Certificate))))
	&& (((decode_TBSCertificate(state, (&(*result).TBSCertificate_key))))
	&& (decode_TBSCertificate(state, (&(*result).TBSCertificate))))
	&& (((decode_biguint(state, (&(*result).CertificateSerialNumber_key))))
	&& (decode_biguint(state, (&(*result).CertificateSerialNumber))))
	&& (((decode_Name(state, (&(*result).Name_key))))
	&& (decode_Name(state, (&(*result).Name))))
	&& (((decode_Attribute(state, (&(*result).Attribute_key))))
	&& (decode_Attribute(state, (&(*result).Attribute))))
	&& (((decode_AlgorithmIdentifier(state, (&(*result).AlgorithmIdentifier_key))))
	&& (decode_AlgorithmIdentifier(state, (&(*result).AlgorithmIdentifier))))
	&& (((decode_Extensions(state, (&(*result).Extensions_key))))
	&& (decode_Extensions(state, (&(*result).Extensions))))
	&& (((decode_Extension(state, (&(*result).Extension_key))))
	&& (decode_Extension(state, (&(*result).Extension))))
	&& (((zcbor_bstr_decode(state, (&(*result).KeyIdentifier_key))))
	&& (zcbor_bstr_decode(state, (&(*result).KeyIdentifier))))
	&& (((zcbor_bstr_decode(state, (&(*result).SubjectKeyIdentifier_key))))
	&& (zcbor_bstr_decode(state, (&(*result).SubjectKeyIdentifier))))
	&& (((zcbor_int32_decode(state, (&(*result).KeyUsage_key))))
	&& (zcbor_int32_decode(state, (&(*result).KeyUsage))))
	&& (((decode_PolicyMappings(state, (&(*result).PolicyMappings_key))))
	&& (decode_PolicyMappings(state, (&(*result).PolicyMappings))))
	&& (((zcbor_int32_decode(state, (&(*result).BasicConstraints_key))))
	&& (zcbor_int32_decode(state, (&(*result).BasicConstraints))))
	&& (((decode_PolicyConstraints(state, (&(*result).PolicyConstraints_key))))
	&& (decode_PolicyConstraints(state, (&(*result).PolicyConstraints))))
	&& (((decode_KeyPurposeId(state, (&(*result).KeyPurposeId_key))))
	&& (decode_KeyPurposeId(state, (&(*result).KeyPurposeId))))
	&& (((decode_ExtKeyUsageSyntax(state, (&(*result).ExtKeyUsageSyntax_key))))
	&& (decode_ExtKeyUsageSyntax(state, (&(*result).ExtKeyUsageSyntax))))
	&& (((zcbor_uint32_decode(state, (&(*result).InhibitAnyPolicy_key))))
	&& (zcbor_uint32_decode(state, (&(*result).InhibitAnyPolicy))))
	&& (((decode_GeneralName(state, (&(*result).GeneralName_key))))
	&& (decode_GeneralName(state, (&(*result).GeneralName))))
	&& (((decode_GeneralNames(state, (&(*result).GeneralNames_key))))
	&& (decode_GeneralNames(state, (&(*result).GeneralNames))))
	&& (((decode_SubjectAltName(state, (&(*result).SubjectAltName_key))))
	&& (decode_SubjectAltName(state, (&(*result).SubjectAltName))))
	&& (((decode_IssuerAltName(state, (&(*result).IssuerAltName_key))))
	&& (decode_IssuerAltName(state, (&(*result).IssuerAltName))))
	&& (((decode_DistributionPointName(state, (&(*result).DistributionPointName_key))))
	&& (decode_DistributionPointName(state, (&(*result).DistributionPointName))))
	&& (((decode_CRLDistributionPoints(state, (&(*result).CRLDistributionPoints_key))))
	&& (decode_CRLDistributionPoints(state, (&(*result).CRLDistributionPoints))))
	&& (((decode_AccessDescription(state, (&(*result).AccessDescription_key))))
	&& (decode_AccessDescription(state, (&(*result).AccessDescription))))
	&& (((decode_AuthorityInfoAccessSyntax(state, (&(*result).AuthorityInfoAccessSyntax_key))))
	&& (decode_AuthorityInfoAccessSyntax(state, (&(*result).AuthorityInfoAccessSyntax))))
	&& (((decode_KeyIdentifierArray(state, (&(*result).KeyIdentifierArray_key))))
	&& (decode_KeyIdentifierArray(state, (&(*result).KeyIdentifierArray))))
	&& (((decode_AuthorityKeyIdentifier(state, (&(*result).AuthorityKeyIdentifier_key))))
	&& (decode_AuthorityKeyIdentifier(state, (&(*result).AuthorityKeyIdentifier))))
	&& (((decode_PolicyIdentifier(state, (&(*result).PolicyIdentifier_key))))
	&& (decode_PolicyIdentifier(state, (&(*result).PolicyIdentifier))))
	&& (((decode_PolicyQualifierInfo(state, (&(*result).PolicyQualifierInfo_key))))
	&& (decode_PolicyQualifierInfo(state, (&(*result).PolicyQualifierInfo))))
	&& (((decode_CertificatePolicies(state, (&(*result).CertificatePolicies_key))))
	&& (decode_CertificatePolicies(state, (&(*result).CertificatePolicies))))
	&& (((decode_GeneralSubtrees(state, (&(*result).GeneralSubtrees_key))))
	&& (decode_GeneralSubtrees(state, (&(*result).GeneralSubtrees))))
	&& (((decode_NameConstraints(state, (&(*result).NameConstraints_key))))
	&& (decode_NameConstraints(state, (&(*result).NameConstraints))))
	&& (((decode_Attributes(state, (&(*result).Attributes_key))))
	&& (decode_Attributes(state, (&(*result).Attributes))))
	&& (((decode_SubjectDirectoryAttributes(state, (&(*result).SubjectDirectoryAttributes_key))))
	&& (decode_SubjectDirectoryAttributes(state, (&(*result).SubjectDirectoryAttributes))))
	&& (((decode_ASIdOrRange(state, (&(*result).ASIdOrRange_key))))
	&& (decode_ASIdOrRange(state, (&(*result).ASIdOrRange))))
	&& (((decode_ASIdentifiers(state, (&(*result).ASIdentifiers_key))))
	&& (decode_ASIdentifiers(state, (&(*result).ASIdentifiers))))
	&& (((zcbor_bstr_decode(state, (&(*result).Address_key))))
	&& (zcbor_bstr_decode(state, (&(*result).Address))))
	&& (((decode_AddressPrefix(state, (&(*result).AddressPrefix_key))))
	&& (decode_AddressPrefix(state, (&(*result).AddressPrefix))))
	&& (((decode_AddressRange(state, (&(*result).AddressRange_key))))
	&& (decode_AddressRange(state, (&(*result).AddressRange))))
	&& (((decode_IPAddressOrRange(state, (&(*result).IPAddressOrRange_key))))
	&& (decode_IPAddressOrRange(state, (&(*result).IPAddressOrRange))))
	&& (((decode_IPAddressChoice(state, (&(*result).IPAddressChoice_key))))
	&& (decode_IPAddressChoice(state, (&(*result).IPAddressChoice))))
	&& (((decode_IPAddressFamily(state, (&(*result).IPAddressFamily_key))))
	&& (decode_IPAddressFamily(state, (&(*result).IPAddressFamily))))
	&& (((decode_IPAddrBlocks(state, (&(*result).IPAddrBlocks_key))))
	&& (decode_IPAddrBlocks(state, (&(*result).IPAddrBlocks))))
	&& (((decode_SignedCertificateTimestamp(state, (&(*result).SignedCertificateTimestamp_key))))
	&& (decode_SignedCertificateTimestamp(state, (&(*result).SignedCertificateTimestamp))))
	&& (((decode_SignedCertificateTimestamps(state, (&(*result).SignedCertificateTimestamps_key))))
	&& (decode_SignedCertificateTimestamps(state, (&(*result).SignedCertificateTimestamps))))) || (zcbor_list_map_end_force_decode(state), false)) && zcbor_map_end_decode(state))));
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)result, payload_len_out, states,
		(zcbor_decoder_t *)decode_All, sizeof(states) / sizeof(zcbor_state_t), 1);
}
